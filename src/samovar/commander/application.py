...
from samovar.commander.base import BaseCommand
from samovar.commander.exceptions import CommandError
from samovar.commander.ui import ConsoleUserInterface
from samovar.commander.commands import AliasCommand, ConfigCommand
from samovar.commander.options import create_parser, OPTIONS, DEFAULTS
        ...
        if self._commands is None:
            ...
            for module in command_modules:
                ...
                for command in BaseCommand.__subclasses__():
                    if not command.__module__.startswith('commander.commander'):
                        app, name = command.__module__.split('.')[-2:]
                        self._commands[name] = {
                            'app': app,
                            'klass': command,
                        }
